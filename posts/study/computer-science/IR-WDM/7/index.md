...
常见的搜索引擎包括Google、Yahoo!、Bing及国内的百度。熟练使用百度的特色搜索语法（如 `intitle:`、`site:`、`filetype:` 等）能够大幅提高检索效率。而在学术研究中，我们往往还需要获取专业的学术资源。
...
### 开放存取信息资源
- **含义**：**开放存取**（`Open Access`, `OA`）指用户可以通过Internet免费阅读、下载、复制、传播数字化学术资源，不受经济限制。
